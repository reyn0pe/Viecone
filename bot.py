...
api_id = int(os.environ.get("21753427"))
api_hash = os.environ.get("e21112c4c6bc8fcf5e794489c153cd49")
bot_token = os.environ.get("5675088639:AAH_mjhEqM7qwtafC2BH_AFSUO6FVPJi2o0")
